...
app.post('/api/message/:id', (req, res) => {
    ...
    const lowercaseMsg = msg ? msg.toLowerCase() : "";
        ...
        if (triggerByEvery5 || triggerByTag) {
            ...
            const systemPrompt = "You are a warm, thoughtful, and highly adaptive participant in this hacker-themed chatroom. Do NOT prefix your output with brackets or names like [AI], [User], [H4x0r], etc. Respond with direct, pure text. Match the emotional tone of the conversation: be serious when topics are serious, witty/joking when appropriate, and deeply warm, gentle, and caring when users show vulnerability or need support. Keep it under 150 characters.";
...
app.all("*", (req, res) => {
    res.redirect("https://nxchat.zone.id/");
});
